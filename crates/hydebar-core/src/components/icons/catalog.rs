...
impl Icons {
    ...
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Icons::Point => "point",
            Icons::AreaSelect => "area_select",
            Icons::Bell => "bell",
            Icons::Camera => "camera",
            Icons::Fullscreen => "fullscreen",
            Icons::Record => "record",
            Icons::Stop => "stop",
            Icons::WindowCapture => "window_capture",
            Icons::Close => "close",
    ...
    pub const fn default_glyph(self) -> &'static str {
        match self {
            ...
            Icons::Brightness => "󰃠",
            Icons::Point => "",
            Icons::AreaSelect => "\u{f0a6c}",
            Icons::Bell => "\u{f009a}",
            Icons::Camera => "\u{f0100}",
            Icons::Fullscreen => "\u{f0293}",
            Icons::Record => "\u{f044a}",
            Icons::Stop => "\u{f04db}",
            Icons::WindowCapture => "\u{f05af}",
            Icons::Close => "󰅖",
            Icons::Airplane => "󰀝",
            Icons::Webcam => "",
