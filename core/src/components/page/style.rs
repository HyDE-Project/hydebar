...
pub const CONTROL_SCALE: f32 = 0.85;
...
pub const CAPTION_SCALE: f32 = 0.75;
...
pub const LINE_HEIGHT_EM: f32 = 1.3;
...
pub const BUTTON_PADDING_EM: [f32; 2] = [0.5, 1.0];
...
pub const SECTION_GAP_EM: f32 = 1.4;
...
pub const PAGE_PADDING_EM: f32 = 0.25;
...
pub const SECTION_TITLE_SCALE: f32 = 1.0;
...
pub const WINDOW_GAP_COUNT: f32 = 3.0;
...
pub const CARD_FILL_ALPHA: f32 = 0.5;
...
pub const CORNER_RADIUS_EM: f32 = 0.5;
...
pub const LABEL_WIDTH_EM: f32 = 13.0;
...
pub const ICON_WIDTH_EM: f32 = 1.0;
...
#[must_use]
pub fn row_pitch(font_size: f32) -> f32 {
...
#[must_use]
pub fn page_height(rows: f32, font_size: f32) -> f32 {
    2.0f32.mul_add(page_padding(font_size), rows * row_pitch(font_size))
}
