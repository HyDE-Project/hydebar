...
//!
//! Two rooms, by how much of the button is painted. A button that is only
//! there when the pointer is on it is [`quiet`]; one that carries a border or
//! a fill of its own is [`stated`].

mod quiet;
mod stated;

pub use quiet::{ghost_button_style, menu_entry_button_style};
pub use stated::{confirm_button_style, outline_button_style, settings_button_style};
